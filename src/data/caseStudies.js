export const caseStudies = [
  ...
  },
  {
    ...
    summary: 'A high-converting custom Webflow site and targeted Google Ads campaign for a luxury Australian home decor brand.',
    headline: 'Elevating premium furniture online with rich visual storytelling and organic reach.',
    challenge: 'Verde struggled with low online conversions and high Google Ads acquisition costs due to an outdated mobile storefront and unoptimised product pages.',
    approach: [
  ...
  },
  {
    ...
    summary: 'A hyper-local SEO and Google Local Services Ads strategy that dominated search results across greater Melbourne.',
    headline: 'Dominating Melbourne local search for waste management and equipment hire.',
    challenge: 'Kanga Skips was losing local market share to national aggregators who controlled the top Google Map Pack rankings.',
    approach: [
  ...
  },
  {
    ...
    summary: 'Optimised Meta ads and custom landing pages driving high-converting commercial solar inquiries in Queensland.',
    headline: 'Connecting commercial solar solutions with decision-makers through precision paid social.',
    challenge: 'Apex Solar was receiving low-quality consumer inquiries while burning ad budget attempting to target enterprise commercial property owners.',
    approach: [
  ...
  },
  {
    ...
    summary: 'A multi-channel app store launch and subscription acquisition funnel for a boutique Australian gym chain.',
    headline: 'Scaling hybrid digital fitness memberships across Sydney and Brisbane.',
    challenge: 'Urban Fitness needed to monetize their hybrid gym platform and boost mobile app downloads without relying solely on expensive paid search.',
    approach: [
  ...
  },
  {
    ...
    summary: 'A complete B2B digital transformation, global SEO overhaul, and custom partner portal.',
    headline: 'Positioning an Australian exporter for global B2B digital acquisition.',
    challenge: 'Oceanic relied on trade shows for commercial deals and had virtually zero digital visibility across international Asian and North American trade channels.',
    approach: [
  ...
  },
  {
    ...
    summary: 'A high-speed Shopify Plus theme customization and Klaviyo lifecycle strategy driving repeat sales.',
    headline: 'Maximizing lifetime customer value for an organic Australian skincare line.',
    challenge: 'High initial customer acquisition costs were eating into margins due to a low repeat purchase rate and fragmented post-purchase communication.',
    approach: [
  ...
  },
  {
    ...
    summary: 'Content strategy, institutional SEO, and search advertising for a high-net-worth wealth advisor firm.',
    headline: 'Building digital trust and attracting high-net-worth investors in Sydney.',
    challenge: 'Strict regulatory compliance and a highly conservative audience made traditional digital ad acquisition difficult and inefficient.',
    approach: [
  ...
  },
  {
    ...
    summary: 'Scaling an outdoor adventure brand across Australia and New Zealand via UGC ads and custom checkout apps.',
    headline: 'Turning rugged outdoor gear into a multi-million dollar e-commerce brand.',
    challenge: 'Tasman faced seasonal sales slumps and struggled to scale their Meta ad spend without experiencing severe creative fatigue.',
    approach: [
  ...
  },
  {
    ...
    summary: 'Complete rebrand, React web platform, and B2B organic search strategy for commercial builders.',
    headline: 'Modernising a tier-2 commercial builder’s digital footprint to win major tenders.',
    challenge: 'An outdated corporate website was undermining sales efforts when pitching for multi-million dollar commercial government tenders.',
    approach: [
  ...
  },
  {
    ...
    summary: 'Local search domination and automated patient booking funnel for multi-clinic dental practice.',
    headline: 'Filling practice appointment books through frictionless local digital booking.',
    challenge: 'High cost-per-click on Google Search ads made acquiring new cosmetic and general dental patients unprofitable.',
    approach: [
